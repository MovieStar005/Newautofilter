...
CODE = (environ.get('CODE', 'https://telegra.ph/Payment-Information-02-03-3'))
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1001573863139')) #Notification of those who verify will be sent to your channel. Enter the ID of the channel you want to send notification to here.
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002096756735')) # add premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1001852506342') #Channel / Group Id for force sub ( make sure bot is admin )
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1002096756735')) #Log channel id ( make sure bot is admin )
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'urlwala.com')
SHORTLINK_API = environ.get('SHORTLINK_API', 'd8835920f4453699343a04fd3b116e50c0e54221')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/All_Movie_Support') #Support group link ( make sure bot is admin )
