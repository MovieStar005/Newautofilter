...
auth_channel = environ.get('AUTH_CHANNEL', '-1001573863139 -1002280917914') #Channel / Group Id for force sub ( make sure bot is admin )
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'cc5016ec98fc49df57b0a9e710a3805cb7fb421a')
